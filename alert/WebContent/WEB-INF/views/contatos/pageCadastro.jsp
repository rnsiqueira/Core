...
<body>
	...
	<div class="container-fluid">
		...
		<div class="container well" align="left">
			...
			<form class="form" role="form" action="addContato" method="post">

				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							<label>Nome:</label><br> <input class="form-control"
								type="text" name="NOME_CONTATO">
						</div>
					</div>
					...
					<div class="col-sm-12">
						<div class="form-group">
							<label>Email:</label><br> <input type="email"
								class="form-control" name="EMAIL_CONTATO">
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-3">
						<div class="form-group">
							...
							<input class="form-control" type="password" name="SENHA_CONTATO">
						</div>
					</div>

					<div class="col-sm-3">
						<div class="form-group">
							<label>Celular:</label><br> <input class="form-control"
