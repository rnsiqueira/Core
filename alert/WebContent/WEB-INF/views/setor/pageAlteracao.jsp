...
<body>
	...
	<div class="container-fluid">
		...
		<div class="container well" align="left">
			...
			<form class="form" role="form" action="alterSetor" method="post">
			
				<div class="row">
					<div class="col-sm-4">
						<div class="form-group">
							<label>Nome do Setor:</label><br>
							 <input	class="form-control" type="text" name="nom_setor" value="${setor.nom_setor}"/>
						</div>
					</div>
					
					<input	class="form-control" type="hidden" name="cod_setor" value="${setor.cod_setor}"/>

					<div class="col-sm-4">
						<div class="form-group">
							<label>Nome do Setor Reduzido:</label><br> <input
								class="form-control" type="text" name="nom_setor_reduzido" value="${setor.nom_setor_reduzido}"/>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<input class="form-control"
								type="hidden" name="url_link" value="${setor.url_link}">
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="form-group">
							<input class="form-control"
								type="hidden" name="url_imagem" value="${setor.url_imagem}">
						</div>
					</div>
